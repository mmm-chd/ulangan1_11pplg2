                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              SvgPicture.asset("assets/images/social_images/apple_icon.svg"),
                              const SpacingComponent(width: 16),
                              SvgPicture.asset("assets/images/social_images/facebook_icon.svg"),
                              const SpacingComponent(width: 16),
                              SvgPicture.asset("assets/images/social_images/google_icon.svg"),
                            ],
                          ),
                        ],
                      ),
